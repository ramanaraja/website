 ...
 This will deploy two artifacts, target/website.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/website.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/website.war

 To undeploy the application, run:

  ./asadmin undeploy website
